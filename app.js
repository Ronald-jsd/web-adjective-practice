        ...
        sub.items.forEach((item, idx) => {
            ...
            rowsHtml += `
                <tr class="${idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'} hover:bg-gray-100 transition-colors">
                    <td class="py-2.5 px-3 border-b" data-label="Adjective">${wordEn}</td>
                    <td class="py-2.5 px-3 border-b" data-label="Pronun."><span class="text-xs text-gray-500 font-mono">[${item[1]}]</span></td>
                    <td class="py-2.5 px-3 border-b" data-label="Español">${wordEs}</td>
                    <td class="py-2.5 px-3 border-b" data-label="Example EN">${exampleEn}</td>
                    <td class="py-2.5 px-3 border-b" data-label="Example ES">${exampleEs}</td>
                </tr>
            `
        })
